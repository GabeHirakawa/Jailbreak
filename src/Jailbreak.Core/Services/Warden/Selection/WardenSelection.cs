...
/// Migrated from Jailbreak.Warden.Selection.WardenSelectionBehavior.
/// </summary>
public class WardenSelection : IWardenSelectionService {
  ...
  protected void OnChooseWarden() {
    ...
    logger.LogTrace("[WardenSelection] Picking warden from {@Eligible}",
      eligible);
    ...
    // Disable the warden raffle for future wardens (eg in the event of warden death)
  }
