...
public class CannotRightKnife(BasePlugin plugin) : AbstractOnTickReward(plugin) {
  public override string Name => "Cannot Right-Knife";
  public override string Description => "You will not be able to right-click knife next round.";
